              ...
              <div className="flex gap-4">
                {selectedProject.live && (
                  <a
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-black text-white font-medium hover:bg-gray-800 transition-all duration-300"
                  >
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {selectedProject.github && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-white text-black border border-black font-medium hover:bg-gray-100 transition-all duration-300"
                  >
